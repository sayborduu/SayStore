...
struct SourceAppsView: View {
	@AppStorage("SayStore.sortOptionRawValue") private var _sortOptionRawValue: String = SortOption.default.rawValue
	@AppStorage("SayStore.sortAscending") private var _sortAscending: Bool = true
