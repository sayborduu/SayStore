...
struct SettingsView: View {
	@AppStorage("SayStore.selectedCert") private var _storedSelectedCert: Int = 0
...
extension SettingsView {
    ...
    private func _makeGitHubIssueURL(url: String) -> String {
        ...
        switch UserDefaults.standard.integer(forKey: "SayStore.installationMethod") {
        case 0: // Server
            let serverMethod = UserDefaults.standard.integer(forKey: "SayStore.serverMethod")
            let ipFix = UserDefaults.standard.bool(forKey: "SayStore.ipFix")
