...
//    descriptor.appearance = 0;
	NSInteger style =
		[NSUserDefaults.standardUserDefaults integerForKey:@"SayStore.userInterfaceStyle"];
	NSInteger variant =
		[NSUserDefaults.standardUserDefaults integerForKey:@"SayStore.shouldTintIcons"];
	NSInteger lightDark =
		[NSUserDefaults.standardUserDefaults integerForKey:@"SayStore.shouldChangeIconsBasedOffStyle"];
...
static CGColorRef FRCreateCGColorFromHex(void) {
	NSString *hex =
		[NSUserDefaults.standardUserDefaults
			stringForKey:@"SayStore.userTintColor"];
