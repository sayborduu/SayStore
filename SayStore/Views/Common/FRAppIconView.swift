...
struct FRAppIconView: View {
	...
	@AppStorage("SayStore.userTintColor") private var selectedColorHex: String = "#1E4ED8"
	@AppStorage("SayStore.shouldTintIcons") private var shouldTintIcons: Bool = false
	@AppStorage("SayStore.shouldChangeIconsBasedOffStyle") private var shouldChangeIconsBasedOffStyle: Bool = false
